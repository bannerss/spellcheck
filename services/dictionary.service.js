...
class DictionaryService {
    ...
    async updateFile() {
        try {
            console.log(path_1.default.resolve('./src/models/dic.json'));
            (0, fs_1.writeFileSync)(path_1.default.resolve('./src/models/dic.json'), JSON.stringify(this.root, null, 2), 'utf8');
